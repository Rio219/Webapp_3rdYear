...
<body>
    <div class="container">
            ...
            <div class="sidebar">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="/Webapp_3rdYear/sellers" class="active">Seller</a>
        ...
        <main>
            ...
            <div class="address">
                <!-- <input type="date"> -->
                <th>Home/Users/Seller</th>
            </div>
            <div class="btn">
			    <i class="fa-solid fa-pencil"></i>
			    <a href="sellers/add" class="btn-add">New Seller</a>
			</div>
    ...
    <script>
	    ...
	    function showMess (userId){
	    	...
	    	if (option === true){
	    		window.location.href = 'deleteseller?sid='+userId;
	    	}
	    }
